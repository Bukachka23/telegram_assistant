...
Split up the behavior of the class via Extract Class . If different classes have the same behavior, you may want to combine the classes through inheritance ( Extract Superclass and Extract Subclass ).


## Payoff

Improves code organization. Reduces code duplication. Simplifies support.
