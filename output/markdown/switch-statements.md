...
**URL:** https://refactoring.guru/smells/switch-statements
...
When a switch operator performs simple actions, there’s no reason to make code changes. Often switch operators are used by factory design patterns ( Factory Method or Abstract Factory ) to select a created class.
