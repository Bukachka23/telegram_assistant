...
**URL:** https://refactoring.guru/smells/duplicate-code
...
Merging duplicate code simplifies the structure of your code and makes it shorter. Simplification + shortness = code that’s easier to simplify and cheaper to support.
