...
**URL:** https://refactoring.guru/smells/alternative-classes-with-different-interfaces
**Type:** smell  |  **Category:** Object-Orientation Abusers
...
You get rid of unnecessary duplicated code, making the resulting code less bulky. Code becomes more readable and understandable (you no longer have to guess the reason for creation of a second class performing the exact same functions as the first one).
