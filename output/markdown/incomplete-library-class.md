...
**URL:** https://refactoring.guru/smells/incomplete-library-class
**Type:** smell  |  **Category:** Other Smells
...
To introduce a few methods to a library class, use Introduce Foreign Method . For big changes in a class library, use Introduce Local Extension .
